							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<div class="portlet-body">
												<div class="row">
													<div class="col-sm-12 table-responsive">
														...
														<div class="table-responsive">
															<table class="table table-bordered table-fixedheader table-striped" id="tbl_batch" style="font-size:10px">
																...
																<tbody id="table_body" >
																	...
																	<tr id="tr_batch_item<?php echo e($cnt); ?>">
																		<td style="width:5.14%; padding-bottom: 0px;padding-top: 2px;padding-left: 4px;padding-right: 0px;">
																			<a href="#" class="btn btn-primary input-sm" onclick="editBatch(<?php echo e($cnt); ?>)" id="editDetails">
																				<i class="fa fa-edit"></i>
																			</a>
																		</td>
																		<td style="width:5.14%" class="batch_item<?php echo e($cnt); ?> inputBatchId" name="inputId">
																			<?php echo e($cnt); ?>

																		</td>
																		<td style="width:7.14%" class="batch_item<?php echo e($cnt); ?> inputItemNo" name="inputItemNo">
																			<?php echo e($piddata->item); ?>

																		</td>
																		<td style="width:11.14%" class="batch_item<?php echo e($cnt); ?> inputItem" name="inputItem">
																			<?php echo e($piddata->description); ?>

																		</td>
																		<td style="width:7.14%" class="batch_item<?php echo e($cnt); ?> inputLocation" name="inputLocation">
																			<?php echo e($piddata->location); ?>

																		</td>
																		<td class="batch_item<?php echo e($cnt); ?> inputwhs100" name="inputWhs100" style="width:7.14%;text-align: right;">
																			<?php echo e($piddata->whs100); ?>

																		</td>
																		<td class="batch_item<?php echo e($cnt); ?> inputwhs102" name="inputWhs102" style="width:7.14%;text-align: right;">
																			<?php echo e($piddata->whs102); ?>

																		</td>
																		<td class="batch_item<?php echo e($cnt); ?> inputwhsnon" name="inputWhsnon" style="width:7.14%;text-align: right;">
																			<?php echo e($piddata->whsnon); ?>

																		</td>
																		<td class="batch_item<?php echo e($cnt); ?> inputwhssm" name="inputWhssm" style="width:7.14%;text-align: right;">
																			<?php echo e($piddata->whssm); ?>

																		</td>
																		<td class="batch_item<?php echo e($cnt); ?> inputwhsng" name="inputWhsng" style="width:7.14%;text-align: right;">
																			<?php echo e($piddata->whsng); ?>

																		</td>
																		<td class="batch_item<?php echo e($cnt); ?> inputInventoryQty" name="inputInventoryQty" style="width:7.14%;text-align: right;">
																			<?php echo e($piddata->inventory_qty); ?>

																		</td>
																		<td class="batch_item<?php echo e($cnt); ?> inputActualQty" name="inputActualQty" style="width:7.14%;text-align: right;">
																			<?php echo e($piddata->actual_qty); ?>

																		</td>
																		<td class="batch_item<?php echo e($cnt); ?> inputVariance" name="inputVariance" style="width:7.14%;text-align: right;">
																			<?php echo e($piddata->variance); ?>

																		</td>
																		<td style="width:7.14%" class="batch_item<?php echo e($cnt); ?> inputRemarks" name="inputRemarks">
																			<?php echo e($piddata->remarks); ?>
														...
														<input type="hidden" name="total_act" id="total_act" value="<?php echo e($act); ?>">
														<input type="hidden" name="total_var" id="total_var" value="<?php echo e($var); ?>">
								...
								<div class="row">
									<div class="col-md-12 text-center">
									  ...
									  <?php /* <a href="javascript:;" class="btn btn-sm btn-warning" id="inspect">Inspect</a> */ ?>
						...
						<div class="col-md-12">
							<form method="POST" action="" class="form-horizontal" id="addissmdl">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control input-sm" id="edit_item" name="edit_item" value="<?php echo e($code); ?>"  disabled="disable">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3 input-sm">Description</label>
									<div class="col-sm-9">
										<input type="text" class="form-control input-sm" id="edit_item_desc" name="edit_item_desc" value="<?php echo e($name); ?>"  disabled="disable">
									</div>
								</div>
								<div class="form-group">
...
<?php $__env->startPush('script'); ?>
	<script type="text/javascript">
			...
			statusValue()
		       ...
		       query.split("&").forEach(function(part)
		       {
	       		...
	       		$('#btn_report_excel').on('click',function(){
					...
					var url = "<?php echo e(url('/wbsPiReport_Excel?inventoryno=')); ?>" + inventoryno + "&location" + location;
		...
		**/
		...
		{
			var url = "<?php echo e(url('/wbsphygetbrdetails')); ?>";
