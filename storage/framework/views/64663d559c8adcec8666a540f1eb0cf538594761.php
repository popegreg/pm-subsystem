...
<div id="searchModal" class="modal fade" role="dialog">
	<div class="modal-dialog modal-full">
		<div class="modal-content blue">
			...
			<form class="form-horizontal" method="post" action="<?php echo e(url('/whs-issuance/search-request')); ?>" id="frm_search">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-5">
...
<div id="ConfirmModal" class="modal fade" role="dialog" data-backdrop="static">
	<div class="modal-dialog modal-sm blue">
		<form role="form" method="POST" action="<?php echo e(url('/whs-issuance/cancel-issuance')); ?>" id="frm_cancel">
			<div class="modal-content ">
				<div class="modal-body">
