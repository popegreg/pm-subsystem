													...
													<div class="form-group">
														...
														<div class="col-md-12">
															<select id="preparedby" name="preparedby" class="form-control input-sm" <?php echo($state); ?> >
																<option value=""></option>
																<?php if(isset($preparedby)): ?>
																	<?php foreach($preparedby as $prep): ?>
																		<option value="<?php echo e($prep->user); ?>"
																			<?php if(isset($packingInfo)){ if($packingInfo->preparedby == $prep->user){ echo 'selected';}}?> >
																			<?php echo e($prep->user); ?>
													...
													<div class="form-group">
														...
														<div class="col-md-12">
															<select id="checkedby" name="checkedby" class="form-control input-sm" <?php echo($state); ?> multiple="multiple">
																<option value=""></option>
																<?php if(isset($checkedby)): ?>
																	<?php foreach($checkedby as $checkd): ?>
																		<option value="<?php echo e($checkd->user); ?>"
																			<?php if(isset($packingInfo)){
																...
																<tbody id="view_tbl_body_row">
	                                                  				<?php if(isset($packingdetails)): ?>
																		...
																		<tr>
																			...
																			<td><?php echo e(number_format($details->price,4)); ?></td>
		...
		<div class="modal-dialog modal-sm gray-gallery">
			<div class="modal-content ">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/packinglistsystem-printpdf')); ?>" target="_blank" id="print_form">
								<?php echo csrf_field(); ?>
											...
											<tbody id="edit_tbl_body_row">
	                                            ...
	                                            <?php if(isset($packingdetails)): ?>
													...
													<tr id="tr<?php echo $ctr; ?>" >
														...
														<td><?php echo e($details->item_code); ?><input id="prodcode" type="hidden" class="form-control" name="boxno" value="<?php echo $details->item_code ?>" <?php echo($readonly); ?> ></td>
														<td><?php echo e(number_format($details->price,4)); ?><input id="price" type="hidden" class="form-control" name="boxno" value="<?php echo number_format($details->price,4) ?>" <?php echo($readonly); ?>></td>
	...
	<script type="text/javascript">
		...
		function save()
		{
			...
			if(is_valid)
			{
				...
				$.ajax({
					url: "<?php echo e(url('/packinglistsystem-save')); ?>",
					type: "POST",
					dataType: 'JSON',
					data: data
				})
				.done(function(data)
				{
					...
					if(action =='ADD')
					{
						window.location.href= "<?php echo e(url('/packinglistdetails?selecteditem=')); ?>" + data + "&dbconnection=" + <?php echo e(Auth::user()->productline); ?>;
						$('#recid').val(data);
						$('#printid').val(data);
					}
				})
	    ...
	    function addDetails()
	    {
	        if($('#dbconnection').val() == 0)
	       	...
	       	{
				window.location.href= "<?php echo e(url('/packinglistdetails?dbconnection=')); ?>" + "<?php echo e(Auth::user()->productline); ?>"//$('#txt_db').val();
			}
	    }
	</script>
<?php $__env->stopPush(); ?>
