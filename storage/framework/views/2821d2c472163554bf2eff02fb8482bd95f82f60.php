    ...
    <div style="position: fixed;top: 545px;left: 13px;">
        <table class="table table-borderless" style="margin-top:30px;">
            ...
            <tbody style="font-size:14px">
                ...
                ?>
                        <tr>
                            <th width="15%" class="tdDetails" style="padding-left:30px"><?php echo e($dt->po_no); ?></th>

                            <th width="33%" class="tdDetails" style="padding-left:30px"><?php echo e($dt->description); ?></th>
                ...
                ?>
                <tr>
                    <td colspan="2" class="tdDetails" style="padding-left:20px" ><h3 style="font-size: 24px;padding: 0px;">Control # <?php echo e($details1->packinglist_ctrl); ?></h3></td>
                ...
                <tr>
                    <td colspan="3" class="tdDetails" style="padding-left:20px"><b>NOTE / HIGHLIGHT:</b>
                        ...
                        <b><?php echo e($details1->note_hightlight.$details1->highlight); ?></b>
                    <td>
                    <td colspan="3"></td>
                </tr>
            </tbody>
