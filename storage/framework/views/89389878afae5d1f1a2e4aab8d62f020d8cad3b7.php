...
<?php $__env->startPush('script'); ?>
	<script>
		...
		var SelectedUrl = "<?php echo e(url('/dropdown?option=')); ?>";
		var DeleteUrl = "<?php echo e(url('/dropdown-delete')); ?>";
	</script>
	<script src="<?php echo e(asset(Config::get('constants.PUBLIC_PATH').'assets/global/scripts/dropdown.js')); ?>" type="text/javascript"></script>
<?php $__env->stopPush(); ?>
