...
<?php $__env->startPush('script'); ?>
	<script type="text/javascript">
		...
		$(function() {
			var url = "<?php echo e(url('/packinglistsystemtable')); ?>" + "?from=&&to=&&id=";
			pakinglistTable(url);
		});
	        ...
	        else
	        {
	        	...
	        	else if(action == 'EDIT')
	        	{
	        		...
	        		else
	        		{
						...
						window.location.href= "<?php echo e(url('/packinglistdetails?selecteditem=')); ?>" + selecteditem + "&&dbconnection=" + dbcon;
	        		}
	        	}
	        	else
	        	{
	    ...
	    function addDetails() {
	    	var dbcon = "<?php echo e(Auth::user()->productline); ?>";
			window.location.href= "<?php echo e(url('/packinglistdetails?dbconnection=')); ?>" + dbcon;
	    }
	    ...
	    function search() {
	    	...
	    	var url = "<?php echo e(url('/packinglistsystemtable')); ?>" + "?from="+srch_from+"=&&to="+srch_to+"&&id=";
	    	pakinglistTable(url);
	    }
    </script>
<?php $__env->stopPush(); ?>
