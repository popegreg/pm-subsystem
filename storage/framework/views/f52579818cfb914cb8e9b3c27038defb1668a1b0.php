		    				...
		    				<table class="table table-striped table-bordered table-condensed" style="font-size: 10px">
		                        ...
		                        <tbody>
		                        	...
		                        	<?php foreach($details as $dt): ?>
		                        		...
		                        		?>
				                        		<tr>
								                    <td><?php echo e($dt->fy.' - '.$dt->ww); ?></td>
								                    <td><?php echo e($dt->date_inspected); ?></td>
								                    <td><?php echo e($dt->device_name); ?></td>
								                    <td><?php echo e($dt->time_ins_from); ?></td>
								                    <td><?php echo e($dt->time_ins_to); ?></td>
								                    <td><?php echo e($dt->submission); ?></td>
								                    <td><?php echo e($dt->lot_qty); ?></td>
								                    <td><?php echo e($dt->sample_size); ?></td>
								                    <td><?php echo e($dt->num_of_defects); ?></td>
								                    <td><?php echo e($dt->lot_no); ?></td>
								                    <td><?php echo e($modid); ?></td>
								                    <td><?php echo e($dt->num_of_defects); ?></td>
								                    <td><?php echo e($dt->judgement); ?></td>
								                    <td><?php echo e($dt->inspector); ?></td>
								                    <td><?php echo e($dt->remarks); ?></td>
								                </tr>
						                <?php
						                	}
						                ?>
