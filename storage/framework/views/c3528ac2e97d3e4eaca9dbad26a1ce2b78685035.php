...
<?php $__env->startSection('content'); ?>
	...
	<?php foreach($userProgramAccess as $access): ?>
		<?php if($access->program_code == Config::get('constants.MODULE_CODE_IQCDB')): ?>  <!-- Please update "2001" depending on the corresponding program_code -->
	...
	<?php echo $__env->make('includes.iqc_inspection-modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    $(function() {
		...
		$('#btn_special_accept').on('click',function() {
			...
			if (requiredFields(':input.required') == true) {
				var url = "<?php echo e(url('/iqcspecialaccept')); ?>";
