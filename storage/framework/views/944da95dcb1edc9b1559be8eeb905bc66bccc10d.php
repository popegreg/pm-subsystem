...
<div id="form_inventory_modal" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog">
        ...
        <div class="modal-content blue">
            ...
            <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/wbs-inventory-save')); ?>"
                id="frm_inventory">
                <div class="modal-body">
                    <?php echo csrf_field(); ?>
                ...
                <div class="modal-footer">
                    <?php /* <button type="submit" class="btn btn-success" <?php echo e($state); ?>><i class="fa fa-save"></i>
                    Save</button> */ ?>
