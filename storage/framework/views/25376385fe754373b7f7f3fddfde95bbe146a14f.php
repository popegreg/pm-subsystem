...
<div id="runcard_modal" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog gray-gallery">
        <div class="modal-content ">
            ...
            <form class="form-horizontal" method="post" action="<?php echo e(url('/packinginspection/save-runcard')); ?>" id="frm_runcard">
                <?php echo e(csrf_field()); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive" id="tableforruncard">
                                <table class="table table-hover table-bordered table-striped" id="tbl_runcard" style="font-size: 10px;" width="100%" cellspacing="0" data-page-length="33" data-scroll-x="true" scroll-collapse="false">
                                    <thead>
                                        <tr>
...
<div id="mode_of_defects_modal" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog gray-gallery">
        <div class="modal-content ">
            ...
            <form class="form-horizontal" method="post" action="<?php echo e(url('/packinginspection/save-mod')); ?>" id="frm_mode_of_defects">
                <?php echo e(csrf_field()); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered table-striped" id="tbl_mode_of_defects" style="font-size: 10px;" width="100%" cellspacing="0" data-page-length="33" data-scroll-x="true" scroll-collapse="false">
                                    <thead>
                                        <tr>
...
<div id="group_by_modal" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-md gray-gallery">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="frm_dppm" action="<?php echo e(url('/packinginspection/calculate-dppm')); ?>">
                <div class="modal-body">
                    <?php echo csrf_field(); ?>
