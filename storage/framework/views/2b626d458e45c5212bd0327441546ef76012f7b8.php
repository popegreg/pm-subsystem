...
<div id="ConfirmModal" class="modal fade" role="dialog" data-backdrop="static">
	<div class="modal-dialog modal-sm blue">
		<form role="form" method="POST" action="<?php echo e(url('/wbsprodmatrequest/cancel-request')); ?>" id="frm_cancel">
			<div class="modal-content ">
				<div class="modal-body">
...
<div id="searchModal" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-full">
        ...
        <!-- Modal content-->
        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/wbsprodmatrequest/search-request')); ?>" id="frm_search">
            <?php echo csrf_field(); ?>
