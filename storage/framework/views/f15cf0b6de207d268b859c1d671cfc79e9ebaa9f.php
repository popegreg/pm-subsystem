...
<div id="searchModal" class="modal fade" role="dialog">
	<div class="modal-dialog modal-full">
		...
		<!-- Modal content-->
		<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/material-kitting')); ?>">
			<?php echo csrf_field(); ?>
	...
	<div class="modal-dialog gray-gallery">
		<div class="modal-content ">
			...
			<form class="form-horizontal">
				...
				<div class="modal-footer">
					<?php /* <a class="btn btn-success" target="_blank">Search</a> */ ?>
...
<div id="check_issuance_details" class="modal fade" role="dialog" data-backdrop="static">
	<div class="modal-dialog modal-lg gray-gallery">
		<div class="modal-content ">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
				        ...
				        <thead>
				            <tr>
				           		 <?php /* <th> <input type="checkbox" name="select_all" value="1" id="example-select-all"></th> */ ?>
				           		 <?php /* <th> <input name="select_all" value="1" id="example-select-all" type="checkbox" /></th>  */ ?> 
			...
			<div class="modal-footer">
				<?php /* <a href="javascript:;" class="btn btn-danger" id="btn_add_issuance"><i class="fa fa-trash"></i>Delete</a> */ ?>
