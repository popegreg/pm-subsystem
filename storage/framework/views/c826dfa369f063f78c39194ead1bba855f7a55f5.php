        ...
        <?php echo e(csrf_field()); ?>
            ...
            <div class="form-group <?php echo e($errors->has('user_id') ? 'has-error' : ''); ?>">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control input-sm placeholder-no-fix" type="text" placeholder="User ID" name="user_id" id="user_id" value="<?php echo e(old('user_id')); ?>" autocomplete="off" />
