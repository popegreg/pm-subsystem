													...
													<div id="eyp" class="panel-collapse collapse">
														<div class="panel-body">
															<table class="table table-striped table-hover table-bordered" id="tbl_eyp">
																...
																<tbody>
																	<?php foreach($eypprog as $eypprg): ?>
																		<tr>
																			<td>
																				<?php echo e($eypprg->program_name); ?>

																				<input type="hidden" name="prog_code[]" value="<?php echo e($eypprg->program_code); ?>">
																				<input type="hidden" name="prog_name[]" value="<?php echo e($eypprg->program_name); ?>">
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes rw EYPrw" name="rw[]" value="<?php echo e($eypprg->program_code); ?>" 
																				<?php echo e($state); ?>

																					<?php if(isset($progs[$eypprg->program_code])): ?>
																						<?php if($progs[$eypprg->program_code] == 1): ?>
																							<?php echo e("checked"); ?>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes r EYPr" name="r[]" value="<?php echo e($eypprg->program_code); ?>"
																				 <?php echo e($state); ?>

																					<?php if(isset($progs[$eypprg->program_code])): ?>
																						<?php if($progs[$eypprg->program_code] == 2): ?>
																							<?php echo e("checked"); ?>
													...
													<div id="NAV" class="panel-collapse collapse">
														<div class="panel-body">
															<table class="table table-striped table-hover table-bordered" id="tbl_extract">
																...
																<tbody>
																	<?php foreach($dataextraction as $dtextr): ?>
																		<tr>
																			<td>
																				<?php echo e($dtextr->program_name); ?>

																				<input type="hidden" name="prog_code[]" value="<?php echo e($dtextr->program_code); ?>">
																				<input type="hidden" name="prog_name[]" value="<?php echo e($dtextr->program_name); ?>">
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes rw yprw" name="rw[]" value="<?php echo e($dtextr->program_code); ?>" <?php echo($state); ?>
																					<?php if(isset($progs[$dtextr->program_code])): ?>
																						<?php if($progs[$dtextr->program_code] == 1): ?>
																							<?php echo e("checked"); ?>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes r ypr" name="r[]" value="<?php echo e($dtextr->program_code); ?>" <?php echo($state); ?> 
																					<?php if(isset($progs[$dtextr->program_code])): ?>
																						<?php if($progs[$dtextr->program_code] == 2): ?>
																							<?php echo e("checked"); ?>
