...
<?php $__env->startPush('css'); ?>
    <link href="<?php echo e(asset(Config::get('constants.PUBLIC_PATH').'assets/global/plugins/bootstrap-editable/bootstrap-editable/css/bootstrap-editable.css')); ?>" rel="stylesheet" type="text/css"/>
<?php $__env->stopPush(); ?>
                                            ...
                                            <tbody style="font-size:10px">
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><a class="draft_shipment_update" data-name="draft_shipment" data-ctrl="<?php echo e($inv->packinglist_ctrl); ?>" data-pk="<?php echo e($inv->po_no); ?>"><?php echo e($inv->draft_shipment); ?></a></td>
                                                            ...
                                                            <?php /* <td><?php echo e($inv->products); ?></td>
                                                            ...
                                                            <?php /* <td><?php echo e($inv->revision_no); ?></td>
...
<?php $__env->startPush('script'); ?>
    <script type="text/javascript" src="<?php echo e(asset(Config::get('constants.PUBLIC_PATH').'assets/global/plugins/bootstrap-editable/bootstrap-editable/js/bootstrap-editable.js')); ?>"></script>
    <?php /* <script type="text/javascript" src="<?php echo e(asset(Config::get('constants.PUBLIC_PATH').'assets/admin/pages/scripts/form-editable.js')); ?>"></script> */ ?>
    <script type="text/javascript">
        $(function() {
            ...
            $('.draft_shipment_update').editable({
                ...
                type: 'text',
                url:"<?php echo e(url('/edit-draftshipment')); ?>"+"?ctrl="+$('.draft_shipment_update').attr('data-ctrl'),
        ...
        function report(reps) {
            ...
            if (reps == 'shipping') {
                 window.location.href= "<?php echo e(url('/shippinglist?from_rep=')); ?>" + from_rep + "&to_rep=" + to_rep;
            }
            if (reps == 'sales') {
