...
@section('content')
    ...
    @include('includes.packing_inspection_modal')
...
@push('script')
    ...
    <script src="{{ asset(config('constants.PUBLIC_PATH').'assets/global/scripts/packing_inspection.js') }}" type="text/javascript"></script>
@endpush