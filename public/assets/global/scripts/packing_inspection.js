...
$( function() {
	...
	$('#packing_code_series').on('change', function() {
		...
		if (_stamp !== undefined) {
			...
			$('#er_inspector').html('Please register to Dropdown Maintenance');
		}
...
function makeDataInspectedTable(url) {
	$('#tbl_packing_inspection').dataTable().fnClearTable();
	$('#tbl_packing_inspection').dataTable().fnDestroy();
...
function makeRuncardTable(arr) {
	$('#tbl_runcard').dataTable().fnClearTable();
	$('#tbl_runcard').dataTable().fnDestroy();
...
function makeMODTable(arr) {
	$('#tbl_mode_of_defects').dataTable().fnClearTable();
	$('#tbl_mode_of_defects').dataTable().fnDestroy();
